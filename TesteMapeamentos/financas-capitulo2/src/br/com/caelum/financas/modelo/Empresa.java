...
public class Empresa {
	...
	@JoinTable(name="empresa_cliente", joinColumns=@JoinColumn(name="id_empresa"),
									   inverseJoinColumns= {@JoinColumn(name="id_cliente",referencedColumnName="id"), @JoinColumn(name="nacionalidade",referencedColumnName="nacionalidadeCodigo")})
	@ManyToMany
